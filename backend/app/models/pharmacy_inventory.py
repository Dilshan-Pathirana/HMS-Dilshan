...
class ProductBase(SQLModel):
    ...
    unit_selling_price: float = Field(default=0)
    expiry_date: Optional[str] = Field(default=None, max_length=20)
    product_store_location: Optional[str] = Field(default=None, max_length=255)
    warranty_serial: Optional[str] = Field(default=None, max_length=100)
    warranty_duration: Optional[str] = Field(default=None, max_length=50)
...
class SupplierBase(SQLModel):
    ...
    supplier_city: Optional[str] = Field(default=None, max_length=255)
    supplier_country: Optional[str] = Field(default=None, max_length=255)
    supplier_type: Optional[str] = Field(default=None, max_length=100)
    products_supplied: Optional[str] = Field(default=None, sa_column=Column(Text))
    delivery_time: Optional[str] = Field(default=None, max_length=100)
    payment_terms: Optional[str] = Field(default=None, max_length=100)
    bank_details: Optional[str] = Field(default=None, sa_column=Column(Text))
    rating: Optional[str] = Field(default=None, max_length=20)
    discounts_agreements: Optional[str] = Field(default=None, sa_column=Column(Text))
