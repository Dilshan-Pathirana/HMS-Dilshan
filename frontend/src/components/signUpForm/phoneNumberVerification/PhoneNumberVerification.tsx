...
const PhoneNumberVerification: React.FC<IPhoneNumberVerificationProps> = ({
    ...
    return (
        <>
            ...
            {phoneExistsError && (
                <div className="w-full bg-error-50 border-2 border-red-300 rounded-xl p-4 flex items-start gap-3 animate-pulse">
                    <div className="flex-shrink-0 w-10 h-10 bg-error-100 rounded-full flex items-center justify-center">
                        <FaExclamationTriangle className="text-error-500 text-xl" />
                    </div>
                    <div className="flex-1">
                        ...
                        <a 
                            href="/login" 
                            className="inline-block mt-2 text-sm text-primary-500 hover:text-blue-800 font-medium underline"
                        >
