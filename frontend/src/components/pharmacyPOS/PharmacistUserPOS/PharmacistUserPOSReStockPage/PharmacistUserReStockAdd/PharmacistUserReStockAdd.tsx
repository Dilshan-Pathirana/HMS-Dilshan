...
import SellingPriceChangeSection from "../../../SuperAdminPOS/SuperAdminPOSReStockPage/SuperAdminReStockAdd/SellingPriceChangeSection.tsx";
...
export default function PharmacistUserAddReStock() {
