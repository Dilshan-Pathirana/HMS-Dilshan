...
import PharmacistUserTransferReasonModal from "./PharmacistUserTransferReasonModal.tsx";
import Pagination from "../../../../Common/Pagination.tsx";

export default function PharmacistUserTransferStockTable({
    products,
    searchTerm,
    setSearchTerm,
    ...
    return (
        <div className="bg-white shadow rounded-lg p-4">
            ...
            />
            <PharmacistUserTransferReasonModal
