...
import { DamageStockTableProps } from "../../../../../../utils/types/pos/IProduct.ts";
import CashierUserDamageReasonModal from "./PharmacistUserDamageReasonModal.tsx";
import Pagination from "../../../../Common/Pagination.tsx";

export default function PharmacistUserDamageStockTable({
    products,
    searchTerm,
    setSearchTerm,
}: DamageStockTableProps) {
    ...
    return (
        <div className="bg-white shadow rounded-lg p-4">
            <div className="flex items-center justify-between mb-4">
                <h2 className="text-xl font-semibold">Damage Stock List</h2>
            </div>
