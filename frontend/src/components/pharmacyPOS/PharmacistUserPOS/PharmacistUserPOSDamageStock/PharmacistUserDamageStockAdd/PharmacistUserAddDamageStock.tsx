...
import PharmacistUserDamageStockForm from "./PharmacistUserDamageStockForm.tsx";
...
import { addDamageStockPharmacistUser } from "../../../../../utils/api/pharmacy/PharmacyPOS/PharmacistUserPOS/PharmacistUserDamageStockAdd.ts";

export default function PharmacistUserAddDamageStock() {
    ...
    const handleAddDamageStock = async () => {
        ...
        try {
            const response = await addDamageStockPharmacistUser(
