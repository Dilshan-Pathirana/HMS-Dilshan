...
import { getAllPurchasing } from "../../../../utils/api/pharmacy/PharmacyPOS/PharmacistUserPOS/PharmacistUserGetAllPurchasing.ts";
...
export default function PharmacistUserPurchasingPage() {
