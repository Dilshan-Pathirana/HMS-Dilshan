...
import CashierUserStockTransferForm from "./CashierUserStockTransferForm.tsx";
...
import {
    addTransferStockCashierUser
} from "../../../../../utils/api/pharmacy/PharmacyPOS/ChasierUserPharmacyPOS/CashierUserTransferStockAdd.ts";

export default function CashierUserStockTransfer() {
    ...
    const handleAddTransferStock = async () => {
        ...
        try {
            const response = await addTransferStockCashierUser(
