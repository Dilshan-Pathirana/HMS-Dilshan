...
import { getAllProducts } from "../../../../utils/api/pharmacy/PharmacyPOS/ChasierUserPharmacyPOS/CashierUserGetAllProducts.ts";
import { purchasingProductCashierUser } from "../../../../utils/api/pharmacy/PharmacyPOS/ChasierUserPharmacyPOS/CashierUserPurchasingProduct.ts";
import {
    IBillPurchasing,
...
import { getAllPatientUsersForCashier } from "../../../../utils/api/user/PatientsUsers.ts";
...
export default function CashierUserSalesPage() {
    ...
    const fetchAllPatients = async () => {
        try {
            const response = await getAllPatientUsersForCashier();
    ...
    const storePurchase = async (
        ...
        try {
            const response = await purchasingProductCashierUser(billDetails);
