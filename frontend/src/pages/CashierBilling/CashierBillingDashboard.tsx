        ...
        <div className="p-6 space-y-6 bg-gray-50 min-h-screen">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6">
                    ...
                    <p className="text-3xl font-bold text-gray-800">Rs. {today_stats.total_sales.toLocaleString()}</p>
                ...
                <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6">
                    ...
                    <p className="text-3xl font-bold text-gray-800">{today_stats.transaction_count}</p>
                ...
                <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6">
                    ...
                    <p className="text-3xl font-bold text-gray-800">Rs. {today_stats.cash_in.toLocaleString()}</p>
                ...
                <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6">
                    ...
                    <p className="text-3xl font-bold text-gray-800">Rs. {today_stats.cash_out.toLocaleString()}</p>
                    <p className="text-xs text-red-600 mt-2">Petty cash & expenses</p>
                </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6">
                <h2 className="text-xl font-bold text-gray-800 mb-4">Payment Mode Breakdown</h2>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="flex items-center gap-4 p-4 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl">
                        ...
                        <div>
                            ...
                            <p className="text-lg font-bold text-gray-800">Rs. {payment_breakdown.cash.toLocaleString()}</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-4 p-4 bg-gradient-to-r from-blue-50 to-cyan-50 border border-blue-200 rounded-xl">
                        ...
                        <div>
                            ...
                            <p className="text-lg font-bold text-gray-800">Rs. {payment_breakdown.card.toLocaleString()}</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-4 p-4 bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200 rounded-xl">
                        ...
                        <div>
                            ...
                            <p className="text-lg font-bold text-gray-800">Rs. {payment_breakdown.online.toLocaleString()}</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-4 p-4 bg-gradient-to-r from-orange-50 to-amber-50 border border-orange-200 rounded-xl">
                        ...
                        <div>
                            ...
                            <p className="text-lg font-bold text-gray-800">Rs. {payment_breakdown.qr.toLocaleString()}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {/* EOD Status Card */}
            <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6">
                <h2 className="text-xl font-bold text-gray-800 mb-4">End of Day Status</h2>
                <div className="flex items-center gap-4">
