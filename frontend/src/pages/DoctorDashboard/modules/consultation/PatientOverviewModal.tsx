    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
                {/* Header */}
                <div className="px-6 py-4 border-b border-neutral-200 flex items-center justify-between bg-gradient-to-r from-primary-500 to-indigo-600">
                    ...
                    <>
                        ...
                        <div className="px-6 py-4 bg-neutral-50 border-b border-neutral-200">
                            <div className="flex items-center gap-4">
                                <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center text-primary-500 font-bold text-2xl">
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="flex flex-wrap items-center gap-4 text-sm text-neutral-600 mt-1">
                                        {data.patient.age && (
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="bg-neutral-50 rounded-xl p-4 space-y-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="font-medium text-error-600">{data.patient.blood_type || 'Unknown'}</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="md:col-span-2 space-y-4">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div className="bg-error-50 rounded-xl p-4 border border-red-200">
                                                <p className="text-sm text-error-600 font-medium mb-2">Known Allergies</p>
                                ...
                                <div className="space-y-4">
                                    {data.past_consultations.length === 0 ? (
                                        <div className="text-center py-12">
                                            ...
                                            <p className="text-neutral-500">No previous consultations</p>
                                        </div>
                                    ) : (
                                        data.past_consultations.map((consultation) => (
                                            ...
                                            >
                                                ...
                                                {consultation.chief_complaint && (
                                                    <div className="mb-3">
                                                        <p className="text-sm text-neutral-500">Chief Complaint</p>
                                                        <p className="text-neutral-800">{consultation.chief_complaint}</p>
                                                    </div>
                                                )}

                                                {consultation.diagnoses.length > 0 && (
                                                    <div className="mb-3">
                                                        <p className="text-sm text-neutral-500 mb-1">Diagnoses</p>
                                                ...
                                                {consultation.prescriptions.length > 0 && (
                                                    <div className="mb-3">
                                                        <p className="text-sm text-neutral-500 mb-1">Prescriptions</p>
                                                ...
                                                {consultation.follow_up_instructions && (
                                                    <div className="bg-blue-50 rounded-lg p-3 mt-3">
                                                        <p className="text-sm text-primary-500 font-medium">Follow-up Instructions</p>
                                                        <p className="text-sm text-neutral-700">{consultation.follow_up_instructions}</p>
                                                    </div>
                                                )}
                                            </div>
                                        ))
                                ...
                                <div className="space-y-4">
                                    {data.all_diagnoses.length === 0 ? (
                                        <div className="text-center py-12">
                                            ...
                                            <p className="text-neutral-500">No diagnoses recorded</p>
                                        </div>
                                    ) : (
                                        <div className="bg-white border border-neutral-200 rounded-xl overflow-hidden">
                                            <table className="w-full">
                                                <thead className="bg-neutral-50">
                                                    <tr>
                                                        <th className="px-4 py-3 text-left text-sm font-medium text-neutral-700">Diagnosis</th>
                                                ...
                                                <tbody className="divide-y divide-gray-100">
                                                    {data.all_diagnoses.map((d, index) => (
                                                        <tr key={index} className="hover:bg-neutral-50">
                                                            <td className="px-4 py-3 font-medium text-neutral-800">{d.diagnosis_name}</td>
                                ...
                                <div className="space-y-4">
                                    {data.medication_history.length === 0 ? (
                                        <div className="text-center py-12">
                                            ...
                                            <p className="text-neutral-500">No medication history</p>
                                        </div>
                                    ) : (
                                        <div className="bg-white border border-neutral-200 rounded-xl overflow-hidden">
                                            <table className="w-full">
                                                <thead className="bg-neutral-50">
                                                    <tr>
                                                        <th className="px-4 py-3 text-left text-sm font-medium text-neutral-700">Medicine</th>
                                                        <th className="px-4 py-3 text-left text-sm font-medium text-neutral-700">Potency</th>
                                                        <th className="px-4 py-3 text-left text-sm font-medium text-neutral-700">Dosage</th>
                                                        <th className="px-4 py-3 text-left text-sm font-medium text-neutral-700">Frequency</th>
                                                        <th className="px-4 py-3 text-left text-sm font-medium text-neutral-700">Date</th>
                                                    </tr>
                                                </thead>
                                                <tbody className="divide-y divide-gray-100">
                                                    {data.medication_history.map((m, index) => (
                                                        <tr key={index} className="hover:bg-neutral-50">
                                                            <td className="px-4 py-3 font-medium text-neutral-800">{m.medicine_name}</td>
                                                            <td className="px-4 py-3 text-neutral-600">{m.potency}</td>
                                                            <td className="px-4 py-3 text-neutral-600">{m.dosage}</td>
                                                            <td className="px-4 py-3 text-neutral-600">{m.frequency}</td>
                                                            <td className="px-4 py-3 text-neutral-500">
