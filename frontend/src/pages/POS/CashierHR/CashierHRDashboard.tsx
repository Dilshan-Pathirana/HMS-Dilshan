...
import {
    ...
    TrendingUp, AlertCircle, ArrowRight, Bell
} from 'lucide-react';
...
const CashierHRDashboard: React.FC = () => {
    ...
    const fetchHRStats = async () => {
        try {
            ...
            const response = await api.get('/hrm/cashier/dashboard-stats', {
    ...
    const hrModules = [
        {
            id: 'schedules',
            title: 'My Schedules',
            description: 'View your work schedule, acknowledge shifts, and request changes',
            icon: <Calendar className="w-8 h-8" />,
            path: '/pos/hr/schedules',
        ...
        },
        {
            ...
            description: 'Request schedule changes, swap shifts, or request time off',
            icon: <Users className="w-8 h-8" />,
            path: '/pos/hr/schedule-requests',
        ...
        },
        {
            ...
            description: 'View overtime hours, salary breakdown, and payslips',
            icon: <Clock className="w-8 h-8" />,
            path: '/pos/hr/overtime-salary',
        ...
        },
        {
            id: 'payslips',
            title: 'My Payslips',
            description: 'Download salary slips and view payment history',
            icon: <DollarSign className="w-8 h-8" />,
            path: '/pos/hr/payslips',
        ...
        },
        {
            id: 'policies',
            title: 'HR Policies',
            description: 'View company policies, guidelines, and employee handbook',
            icon: <BookOpen className="w-8 h-8" />,
            path: '/pos/hr/policies',
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-blue-100 text-sm">
                                Contact HR department for assistance with any queries
                            </p>
                        </div>
                        <button
...
export default CashierHRDashboard;
