            ...
            {message && (
                <div className={`p-4 rounded-xl flex items-center gap-3 ${
                    message.type === 'success' 
                        ...
                        : 'bg-error-50 text-red-700 border border-red-200'
                }`}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                ...
                <div className="lg:col-span-1 space-y-6">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                        <div className="text-center">
                            ...
                            <div className="relative inline-block">
                                ...
                                <label className="absolute bottom-0 right-0 p-2 bg-gradient-to-r from-emerald-500 to-primary-500 rounded-full text-white cursor-pointer hover:shadow-lg transition-shadow">
                            ...
                            <span className="inline-block mt-2 px-3 py-1 bg-gradient-to-r from-emerald-500 to-primary-500 text-white text-xs font-semibold rounded-full">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4">
                        <h4 className="text-sm font-semibold text-neutral-600 mb-3">Account Info</h4>
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center gap-3 text-sm">
                                ...
                                <div className="overflow-hidden">
                                    ...
                                    <p className="font-medium text-neutral-800 truncate">{displayProfile.email}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="lg:col-span-3">
                        ...
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                                ...
                                {!editMode ? (
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <button
                                            ...
                                            disabled={saving}
                                            className="px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-emerald-500 to-primary-500 rounded-lg hover:shadow-lg transition-all flex items-center gap-2"
                                        >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            disabled
                                            className="w-full pl-10 pr-4 py-3 rounded-xl border border-neutral-200 bg-neutral-50 text-neutral-500"
                                        />
                                    </div>
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <div className="relative">
                                        <MapPin className="absolute left-3 top-4 w-5 h-5 text-neutral-400" />
                                        <textarea
                    ...
                    {activeTab === 'password' && (
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                            <h2 className="text-lg font-bold text-neutral-900 mb-6">Change Password</h2>
                            ...
                            <div className="max-w-md space-y-4">
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-10 pr-12 py-3 rounded-xl border border-neutral-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 transition-colors"
                                ...
                                <button
                                    ...
                                    className="w-full mt-4 px-6 py-3 text-white font-medium bg-gradient-to-r from-emerald-500 to-primary-500 rounded-xl hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex items-center justify-between p-4 bg-neutral-50 rounded-xl">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-neutral-500">Receive alerts for transactions</p>
                                        </div>
                                    </div>
                                    <label className="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" defaultChecked className="sr-only peer" />
                                        <div className="w-11 h-6 bg-neutral-200 peer-focus:ring-4 peer-focus:ring-emerald-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-neutral-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-emerald-500"></div>
                                    </label>
                                </div>
                                ...
                                <div className="flex items-center justify-between p-4 bg-neutral-50 rounded-xl">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-neutral-500">Play sound on successful transaction</p>
                                        </div>
                                    </div>
                                    <label className="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" defaultChecked className="sr-only peer" />
                                ...
                                <div className="flex items-center justify-between p-4 bg-neutral-50 rounded-xl">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <h4 className="font-medium text-neutral-900">Auto-lock Screen</h4>
                                            <p className="text-sm text-neutral-500">Lock after 5 minutes of inactivity</p>
                                        </div>
                                    </div>
                                    <label className="relative inline-flex items-center cursor-pointer">
