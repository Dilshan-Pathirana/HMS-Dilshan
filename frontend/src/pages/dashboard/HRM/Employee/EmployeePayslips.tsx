        ...
        <div className="min-h-screen bg-neutral-50 p-6">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-neutral-500">View and download your monthly payslips</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-6 mb-6">
                    <div className="flex items-center justify-between mb-6">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-neutral-500">{latestPayslip.month}</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-2">
                            <button className="flex items-center gap-2 px-4 py-2 border border-neutral-300 text-neutral-700 rounded-lg hover:bg-neutral-50">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-neutral-50 rounded-lg p-4">
                            <h3 className="font-medium text-neutral-700 mb-4">Earnings</h3>
                            <div className="space-y-3">
                                ...
                                <div className="flex justify-between">
                                    <span className="text-neutral-600">Housing Allowance</span>
                                    <span className="font-medium">LKR 20,000</span>
                                </div>
                                <div className="flex justify-between border-t pt-3">
                                    <span className="font-medium text-neutral-700">Gross Salary</span>
                                    <span className="font-bold text-neutral-800">LKR 195,000</span>
                                </div>
                            </div>
                        </div>
                        ...
                        {/* Deductions */}
                        <div className="bg-neutral-50 rounded-lg p-4">
                            <h3 className="font-medium text-neutral-700 mb-4">Deductions</h3>
                            <div className="space-y-3">
                                <div className="flex justify-between">
                                    <span className="text-neutral-600">EPF (Employee 8%)</span>
                                    <span className="font-medium text-error-600">- LKR 12,000</span>
                                </div>
                                <div className="flex justify-between">
                                    <span className="text-neutral-600">Tax (PAYE)</span>
                                    <span className="font-medium text-error-600">- LKR 13,600</span>
                                </div>
                                <div className="flex justify-between border-t pt-3">
                                    <span className="font-medium text-neutral-700">Total Deductions</span>
                                    <span className="font-bold text-error-600">- LKR 25,600</span>
                                </div>
                            </div>
                            <div className="mt-4 p-3 bg-blue-50 rounded-lg">
                                ...
                                <p className="text-xs text-primary-500 mt-1">EPF (12%): LKR 18,000 | ETF (3%): LKR 4,500</p>
                            </div>
                        </div>
                    </div>

                    {/* Net Salary */}
                    <div className="mt-6 p-4 bg-gradient-to-r from-emerald-500 to-primary-500 rounded-lg text-white">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-6">
                    <h2 className="text-lg font-semibold text-neutral-800 mb-4">Payslip History</h2>
                    <div className="overflow-x-auto">
                        <table className="w-full">
                            <thead className="bg-neutral-50 border-b border-neutral-200">
                                <tr>
                                    <th className="text-left py-3 px-4 text-sm font-medium text-neutral-500">Month</th>
                                    <th className="text-left py-3 px-4 text-sm font-medium text-neutral-500">Gross Salary</th>
                                    <th className="text-left py-3 px-4 text-sm font-medium text-neutral-500">Deductions</th>
                                    <th className="text-left py-3 px-4 text-sm font-medium text-neutral-500">Net Salary</th>
                            ...
                            <tbody>
                                {payslips.map((payslip) => (
                                    <tr key={payslip.id} className="border-b border-gray-100 hover:bg-neutral-50">
                                        <td className="py-3 px-4 font-medium text-neutral-800">{payslip.month}</td>
                                        <td className="py-3 px-4 text-neutral-600">LKR {payslip.grossSalary.toLocaleString()}</td>
                                        <td className="py-3 px-4 text-error-600">- LKR {payslip.deductions.toLocaleString()}</td>
                                        ...
                                        <td className="py-3 px-4">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <button className="p-2 text-neutral-500 hover:text-emerald-600 hover:bg-emerald-50 rounded-lg">
                                                    <Download className="w-4 h-4" />
                                                </button>
                                            </div>
                                        </td>
