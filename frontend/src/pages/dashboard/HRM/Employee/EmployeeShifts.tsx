            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-500">View your schedule and acknowledge shifts</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
                        ...
                        <p className="text-2xl font-bold text-gray-800 mt-1">5 shifts</p>
                        <p className="text-xs text-gray-500 mt-1">40 hours scheduled</p>
                    </div>
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
                        <p className="text-gray-500 text-sm">Hours This Month</p>
                        <p className="text-2xl font-bold text-emerald-600 mt-1">156 hrs</p>
                        <p className="text-xs text-gray-500 mt-1">of 176 hrs target</p>
                    </div>
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
                        <p className="text-gray-500 text-sm">Overtime This Month</p>
                        <p className="text-2xl font-bold text-purple-600 mt-1">8.5 hrs</p>
                        <p className="text-xs text-gray-500 mt-1">LKR 12,750 earned</p>
                    </div>
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
                        <p className="text-gray-500 text-sm">Pending Acknowledgment</p>
                        <p className="text-2xl font-bold text-orange-600 mt-1">4</p>
                        <p className="text-xs text-gray-500 mt-1">shifts to confirm</p>
                    </div>
                </div>
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    <div className="text-center min-w-[60px]">
                                        <p className="text-sm font-bold text-gray-800">{shift.date}</p>
                                    ...
                                    <div>
                                        ...
                                        <p className={`text-sm ${
                                            shift.type === 'Morning Shift' ? 'text-blue-600' :
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <h2 className="text-lg font-semibold text-gray-800 mb-4">Recent Shift History</h2>
                        ...
                        <table className="w-full">
                            <thead className="bg-gray-50 border-b border-gray-200">
                                <tr>
                                    ...
                                    <th className="text-left py-3 px-4 text-sm font-medium text-gray-500">Clock In</th>
                                    <th className="text-left py-3 px-4 text-sm font-medium text-gray-500">Clock Out</th>
                            ...
                            <tbody>
                                {shiftHistory.map((shift) => (
                                    <tr key={shift.id} className="border-b border-gray-100 hover:bg-gray-50">
                                        <td className="py-3 px-4 font-medium text-gray-800">{shift.date}</td>
                                        <td className="py-3 px-4 text-gray-600">{shift.time}</td>
                                        ...
                                        <td className="py-3 px-4 text-gray-600">{shift.clockIn}</td>
                                        <td className="py-3 px-4 text-gray-600">{shift.clockOut}</td>
                                        <td className="py-3 px-4 text-gray-600">{shift.hours} hrs</td>
                                        <td className="py-3 px-4">
                                            {shift.overtime > 0 ? (
