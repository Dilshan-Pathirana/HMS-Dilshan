...
const BranchHRMReports: React.FC = () => {
    ...
    const fetchAnalytics = async () => {
        ...
        try {
            ...
            let endpoint = '';
            switch (activeTab) {
                case 'workforce': endpoint = '/hrm/branch-admin/analytics/workforce'; break;
                case 'attendance': endpoint = '/hrm/branch-admin/analytics/attendance'; break;
                case 'leave': endpoint = '/hrm/branch-admin/analytics/leave'; break;
                case 'overtime': endpoint = '/hrm/branch-admin/analytics/overtime'; break;
                case 'payroll': endpoint = '/hrm/branch-admin/payroll'; break;
            }
