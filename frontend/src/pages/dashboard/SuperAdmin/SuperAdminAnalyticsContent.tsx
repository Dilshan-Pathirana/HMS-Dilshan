...
export const SuperAdminAnalyticsContent: React.FC = () => {
    ...
    const revenueBreakdown: ChartData[] = [
        { label: 'OPD Consultations', value: 45, color: 'bg-primary-500' },
    ...
    const qualityMetrics = [
        ...
        { label: 'Average Wait Time', value: 18, unit: 'min', icon: <Clock className="w-5 h-5" />, color: 'text-primary-500' },
        { label: 'Infection Rate', value: 1.2, unit: '%', icon: <Shield className="w-5 h-5" />, color: 'text-error-600' },
        ...
        <div className="p-4 space-y-6">
            ...
            <div className="bg-gradient-to-r from-green-50 via-teal-50 to-cyan-50 border-2 border-teal-200 rounded-xl p-4 md:p-6 shadow-md">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        ...
                        <p className="text-neutral-600 mt-1">Comprehensive performance metrics and insights</p>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <select
                            ...
                            className="px-4 py-2 border-2 border-teal-300 rounded-lg bg-teal-50 text-neutral-800 font-semibold focus:outline-none focus:ring-2 focus:ring-teal-500 transition-all"
                        >
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 bg-white p-4 rounded-lg shadow-md border border-neutral-200">
                ...
                <div className="flex gap-2">
                    <button className="flex items-center gap-2 px-4 py-2 bg-neutral-100 text-neutral-700 rounded-lg hover:bg-neutral-200 transition-all">
                        ...
                        <div className="flex items-start justify-between">
                            <div className="flex-1">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className={`text-sm font-semibold ${metric.trend === 'up' ? 'text-green-600' : 'text-error-600'}`}>
                    ...
                    <table className="w-full min-w-[500px]">
                        <thead className="bg-neutral-50 border-b-2 border-neutral-200">
                            <tr>
                                ...
                                <th className="text-right px-4 py-3 text-sm font-semibold text-neutral-700">Revenue</th>
                                <th className="text-center px-4 py-3 text-sm font-semibold text-neutral-700">Patients</th>
                                <th className="text-center px-4 py-3 text-sm font-semibold text-neutral-700">Margin</th>
                                <th className="text-center px-4 py-3 text-sm font-semibold text-neutral-700">Trend</th>
                            </tr>
                        </thead>
                        <tbody>
                            {departmentPerformance.map((dept, index) => (
                                <tr key={index} className="border-b border-gray-100 hover:bg-neutral-50 transition-colors">
                                    <td className="px-4 py-3 font-medium text-neutral-800">{dept.name}</td>
                                    <td className="px-4 py-3 text-right text-neutral-700">{dept.revenue}</td>
                                    <td className="px-4 py-3 text-center text-neutral-700">{dept.patients}</td>
                                    ...
                                    <td className="px-4 py-3 text-center">
                                        {dept.trend === 'up' ? (
                                            ...
                                            <TrendingDown className="w-5 h-5 text-error-600 mx-auto" />
                                        )}
                                    </td>
                                </tr>
                            ))}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    {doctorPerformance.map((doctor, index) => (
                        <div key={index} className="p-4 bg-gradient-to-br from-teal-50 to-cyan-50 rounded-lg border-2 border-teal-200">
                            <p className="font-bold text-neutral-800 mb-1">{doctor.name}</p>
                            <p className="text-xs text-neutral-600 mb-3">{doctor.specialty}</p>
                            <div className="space-y-2 text-sm">
                                <div className="flex justify-between">
                                    <span className="text-neutral-600">Patients:</span>
                                    <span className="font-semibold text-neutral-800">{doctor.patients}</span>
                                </div>
                                <div className="flex justify-between">
                                    <span className="text-neutral-600">Revenue:</span>
                                    <span className="font-semibold text-neutral-800">{doctor.revenue}</span>
                                </div>
                                <div className="flex justify-between">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    {bedUtilization.map((bed, index) => (
                        <div key={index} className="p-4 bg-neutral-50 rounded-lg border border-neutral-200">
                            <p className="font-semibold text-neutral-800 mb-3">{bed.type}</p>
                            <div className="mb-3">
                                <div className="flex justify-between text-sm mb-1">
                                    <span className="text-neutral-600">Occupancy</span>
                                    <span className="font-semibold text-neutral-800">{bed.occupancy}%</span>
                                </div>
                            ...
                            <div className="space-y-1 text-sm">
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-medium text-neutral-800">{bed.capacity} beds</span>
                                </div>
                                <div className="flex justify-between">
                                    <span className="text-neutral-600">ALOS:</span>
                                    <span className="font-medium text-neutral-800">{bed.alos} days</span>
                                </div>
                            </div>
                        </div>
                    ))}
