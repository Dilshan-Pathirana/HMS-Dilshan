        ...
        <DashboardLayout userName={userName} userRole="Clerk" profileImage={profileImage} sidebarContent={<SidebarMenu items={ClerkMenuItems} />}>
            <div className="space-y-6">
                <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-6">
                    ...
                    <p className="text-neutral-600 mt-1">Manage records and documentation efficiently.</p>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                        <button className="flex items-center gap-3 px-4 py-3 bg-gradient-to-r from-emerald-50 to-blue-50 rounded-lg hover:from-emerald-100 hover:to-blue-100 transition-all">
                            ...
                            <span className="font-medium text-neutral-800">Upload Document</span>
                        </button>
                        <button className="flex items-center gap-3 px-4 py-3 bg-gradient-to-r from-emerald-50 to-blue-50 rounded-lg hover:from-emerald-100 hover:to-blue-100 transition-all">
                            <Search className="w-5 h-5 text-primary-500" />
                            <span className="font-medium text-neutral-800">Search Records</span>
                        </button>
                        <button className="flex items-center gap-3 px-4 py-3 bg-gradient-to-r from-emerald-50 to-blue-50 rounded-lg hover:from-emerald-100 hover:to-blue-100 transition-all">
                            <Archive className="w-5 h-5 text-purple-600" />
                            <span className="font-medium text-neutral-800">Archive Files</span>
                        </button>
                    </div>
                </div>
            </div>
