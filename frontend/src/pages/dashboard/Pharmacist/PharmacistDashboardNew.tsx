...
const PharmacistDashboardNew: React.FC = () => {
    ...
    const getActivityIcon = (type: string) => {
        switch (type) {
            ...
            case 'clarification': return <FileText className="w-5 h-5 text-primary-500" />;
    ...
    return (
        <div className="p-6 space-y-6 bg-neutral-50 min-h-screen ml-64 mt-16">
            {/* Branch Info Header */}
            {branchInfo && (
            ...
            <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-6">
                ...
                <p className="text-neutral-600 mt-1">Here's what's happening at your pharmacy today.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-white rounded-xl shadow-md border border-neutral-200 p-6">
                    ...
                    <p className="text-sm text-neutral-600 mb-1">Prescriptions Today</p>
                    <p className="text-3xl font-bold text-neutral-800">{stats.prescriptionsToday}</p>
                ...
                <div className="bg-white rounded-xl shadow-md border border-neutral-200 p-6">
                    ...
                    <p className="text-sm text-neutral-600 mb-1">Dispensed Today</p>
                    <p className="text-3xl font-bold text-neutral-800">{stats.dispensedToday}</p>
                ...
                <div className="bg-white rounded-xl shadow-md border border-neutral-200 p-6">
                    ...
                    <p className="text-3xl font-bold text-neutral-800">{stats.lowStock}</p>
                ...
                <div className="bg-white rounded-xl shadow-md border border-neutral-200 p-6">
                    ...
                    <p className="text-sm text-neutral-600 mb-1">Near Expiry</p>
                    <p className="text-3xl font-bold text-neutral-800">{stats.nearExpiry}</p>
                    <p className="text-xs text-error-600 mt-2">Within 90 days</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        {recentActivities.map(activity => (
                            <div key={activity.id} className="flex items-start gap-3 p-3 rounded-lg hover:bg-neutral-50 transition-colors">
                                ...
                                <div className="flex-1">
                                    ...
                                    {activity.patient && (
                                        <p className="text-xs text-neutral-500">Patient: {activity.patient}</p>
                                    )}
                ...
                {/* Pending Tasks */}
                <div className="bg-white rounded-xl shadow-md border border-neutral-200 p-6">
                    <h2 className="text-xl font-bold text-neutral-800 mb-4">Pending Tasks</h2>
                    <div className="space-y-3">
                        <div className="flex items-center justify-between p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                            <div className="flex items-center gap-3">
                                <FileText className="w-5 h-5 text-yellow-600" />
                                <div>
                                    <p className="font-medium text-neutral-800">Prescription Clarifications</p>
                                    <p className="text-sm text-neutral-600">{stats.pendingClarifications} pending</p>
                                </div>
                            </div>
                            <button 
                        ...
                        <div className="flex items-center justify-between p-4 bg-error-50 border border-red-200 rounded-lg">
                            <div className="flex items-center gap-3">
                                <AlertTriangle className="w-5 h-5 text-error-600" />
                                <div>
                                    <p className="font-medium text-neutral-800">Low Stock Alerts</p>
                                    <p className="text-sm text-neutral-600">{stats.lowStock} items</p>
                                </div>
                            </div>
                            <button 
                        ...
                        <div className="flex items-center justify-between p-4 bg-orange-50 border border-orange-200 rounded-lg">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="font-medium text-neutral-800">Near Expiry Items</p>
                                    <p className="text-sm text-neutral-600">{stats.nearExpiry} items</p>
                                </div>
                            </div>
                        ...
                        <div className="flex items-center justify-between p-4 bg-purple-50 border border-purple-200 rounded-lg">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="font-medium text-neutral-800">Purchase Requests</p>
                                    <p className="text-sm text-neutral-600">Manage purchase orders</p>
                                </div>
                            </div>
                            <button 
            ...
            <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl border-2 border-blue-200 p-6">
                <h2 className="text-xl font-bold text-neutral-800 mb-4">Today's Summary</h2>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                    <div>
                        <p className="text-sm text-neutral-600 mb-1">OPD Dispensed</p>
                        <p className="text-2xl font-bold text-primary-500">32</p>
                    </div>
                    <div>
                        <p className="text-sm text-neutral-600 mb-1">IPD Dispensed</p>
                        <p className="text-2xl font-bold text-green-600">10</p>
                    </div>
                    <div>
                        <p className="text-sm text-neutral-600 mb-1">Ward Issues</p>
                        <p className="text-2xl font-bold text-purple-600">8</p>
                    </div>
                    <div>
                        <p className="text-sm text-neutral-600 mb-1">Returns Processed</p>
