            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-neutral-500 text-sm">Scheduled Reports</p>
                                    ...
                                    <div className="p-6 bg-neutral-50">
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            {category.reports.map((report) => (
                                                <div key={report.id} className="bg-white rounded-lg p-4 border border-neutral-200 hover:border-blue-300 hover:shadow-md transition-all">
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        <button
                                                            ...
                                                            className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-primary-500 text-white rounded-lg hover:bg-primary-500 transition-colors text-sm"
                                                        >
