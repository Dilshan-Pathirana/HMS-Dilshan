...
export const BranchAdminAppointments: React.FC = () => {
    ...
    const getStatusBadge = (status: string) => {
        const styles = {
            ...
            cancelled: 'bg-error-100 text-red-800 border-red-200'
        };
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-neutral-500 text-sm">Confirmed</p>
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full">
                                <thead className="bg-neutral-50 border-b border-neutral-200">
                                    <tr>
                                        <th className="px-6 py-4 text-left text-xs font-semibold text-neutral-600 uppercase tracking-wider">Patient</th>
                                        <th className="px-6 py-4 text-left text-xs font-semibold text-neutral-600 uppercase tracking-wider">Doctor</th>
                                        <th className="px-6 py-4 text-left text-xs font-semibold text-neutral-600 uppercase tracking-wider">Date & Time</th>
                                ...
                                <tbody className="divide-y divide-gray-200">
                                    {filteredAppointments.map((appointment) => (
                                        <tr key={appointment.id} className="hover:bg-neutral-50 transition-colors">
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <p className="font-medium text-neutral-800">{appointment.patient_name}</p>
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <div>
                                                        <p className="font-medium text-neutral-800">{appointment.doctor_name}</p>
                                                        <p className="text-sm text-neutral-500">{appointment.doctor_specialization}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="px-6 py-4">
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                        <div className="sticky top-0 bg-white border-b border-neutral-200 px-6 py-4 flex items-center justify-between">
                            <h2 className="text-xl font-bold text-neutral-800">Create New Appointment</h2>
                            <button
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-neutral-700 mb-2">Appointment Date</label>
                                <input
                                    type="date"
                            ...
                            <div className="flex items-center gap-3 pt-4">
                                ...
                                <button
                                    onClick={() => setShowCreateModal(false)}
                                    className="px-6 py-3 border border-neutral-300 rounded-xl hover:bg-neutral-50 transition-colors font-medium"
                                >
                                    Cancel
                                </button>
                            </div>
