...
export const BranchAdminAnalytics: React.FC = () => {
    ...
    const revenueBreakdown: ChartData[] = [
        { label: 'OPD', value: 45, color: 'bg-primary-500' },
            ...
            <div className="space-y-6">
                ...
                <div className="bg-gradient-to-r from-emerald-500 to-blue-600 rounded-xl shadow-lg p-6 text-white">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            >
                                <option value="today" className="text-neutral-800">Today</option>
                                <option value="week" className="text-neutral-800">This Week</option>
                                <option value="month" className="text-neutral-800">This Month</option>
                                <option value="quarter" className="text-neutral-800">This Quarter</option>
                                <option value="year" className="text-neutral-800">This Year</option>
                            </select>
                        ...
                        <div key={index} className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                            <div className="flex items-start justify-between mb-4">
                                ...
                                <div className={`flex items-center gap-1 px-2 py-1 rounded-full text-sm font-medium ${
                                    metric.trend === 'up' ? 'bg-green-100 text-green-700' : 'bg-error-100 text-red-700'
                                }`}>
                                    {metric.trend === 'up' ? (
                            ...
                            <h3 className="text-neutral-500 text-sm mb-1">{metric.title}</h3>
                            <p className="text-2xl font-bold text-neutral-800">{metric.value}</p>
                            <p className="text-xs text-neutral-400 mt-2">vs previous period</p>
                        </div>
                    ))}
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                        <div className="flex items-center justify-between mb-4">
                            <h2 className="text-lg font-bold text-neutral-800">Revenue Breakdown</h2>
                        ...
                        <div className="space-y-4">
                            {revenueBreakdown.map((item, index) => (
                                <div key={index}>
                                    ...
                                    {renderProgressBar(item.value, item.color || 'bg-primary-500')}
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                        <div className="flex items-center justify-between mb-4">
                            <h2 className="text-lg font-bold text-neutral-800">Quality Metrics</h2>
                            ...
                            {qualityMetrics.map((metric, index) => (
                                <div key={index} className="flex items-center justify-between p-3 bg-gradient-to-r from-green-50 to-cyan-50 rounded-lg">
                                    <div className="flex-1">
                                        <p className="text-sm font-medium text-neutral-700">{metric.metric}</p>
                                        <p className="text-xs text-neutral-500">Target: {metric.target}</p>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <span className="text-lg font-bold text-neutral-800">{metric.value}</span>
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                    <div className="flex items-center justify-between mb-6">
                        <h2 className="text-lg font-bold text-neutral-800">Department Performance</h2>
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="border-b border-neutral-200">
                                    ...
                                    <th className="text-left py-3 px-4 text-sm font-semibold text-neutral-700">Margin</th>
                            ...
                            <tbody>
                                {departmentPerformance.map((dept, index) => (
                                    <tr key={index} className="border-b border-gray-100 hover:bg-gradient-to-r hover:from-green-50 hover:to-cyan-50 transition-colors">
                                        <td className="py-3 px-4 text-sm font-medium text-neutral-800">{dept.dept}</td>
                                        <td className="py-3 px-4 text-sm text-neutral-700">{dept.revenue}</td>
                                        <td className="py-3 px-4 text-sm text-neutral-700">{dept.patients}</td>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                        <div className="flex items-center justify-between mb-4">
                            <h2 className="text-lg font-bold text-neutral-800">Top Performing Doctors</h2>
                            ...
                            {doctorPerformance.map((doctor, index) => (
                                <div key={index} className="p-4 bg-gradient-to-r from-green-50 to-cyan-50 rounded-lg border border-emerald-100">
                                    ...
                                    <div className="grid grid-cols-3 gap-2 text-sm">
                                        <div>
                                            <p className="text-neutral-500 text-xs">Patients</p>
                                            <p className="font-bold text-neutral-800">{doctor.patients}</p>
                                        </div>
                                        <div>
                                            <p className="text-neutral-500 text-xs">Revenue</p>
                                            <p className="font-bold text-neutral-800">{doctor.revenue}</p>
                                        </div>
                                        <div>
                                            <p className="text-neutral-500 text-xs">Utilization</p>
                                            <p className="font-bold text-neutral-800">{doctor.utilization}%</p>
                                        </div>
                                    </div>
                                </div>
                            ))}
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                        <div className="flex items-center justify-between mb-4">
                            <h2 className="text-lg font-bold text-neutral-800">Bed Utilization</h2>
                        ...
                        <div className="space-y-4">
                            {bedUtilization.map((ward, index) => (
                                <div key={index} className="p-4 bg-gradient-to-r from-green-50 to-cyan-50 rounded-lg border border-emerald-100">
                                    <div className="flex items-center justify-between mb-2">
                                        <h3 className="font-semibold text-neutral-800">{ward.ward}</h3>
                                    ...
                                    {renderProgressBar(ward.occupancy, ward.occupancy >= 80 ? 'bg-green-500' : ward.occupancy >= 60 ? 'bg-yellow-500' : 'bg-error-500')}
                                    <div className="grid grid-cols-3 gap-2 mt-2 text-xs text-neutral-600">
                                        <div>
                                            <span className="text-neutral-500">Capacity:</span> {ward.capacity}
                                        </div>
                                        <div>
                                            <span className="text-neutral-500">Occupied:</span> {ward.occupied}
                                        </div>
                                        <div>
                                            <span className="text-neutral-500">ALOS:</span> {ward.alos}d
                                        </div>
                                    </div>
                                </div>
                            ))}
