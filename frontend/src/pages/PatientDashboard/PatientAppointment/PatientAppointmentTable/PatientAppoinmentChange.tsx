    ...
    if (loading) {
        return (
            <div className="max-w-full">
                <NavBar />
                <div className="min-h-screen bg-neutral-50 pt-20 pb-10 px-4 mt-10">
    ...
    if (error) {
        return (
            <div className="max-w-full">
                <NavBar />
                <div className="min-h-screen bg-neutral-50 pt-20 pb-10 px-4 mt-10">
                    <div className="max-w-7xl mx-auto text-center py-20 text-error-500">
                        {error}
                    </div>
                </div>
            </div>
                        ...
                        <div className="flex-1">
                            <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="bg-neutral-50 rounded-lg p-5 border border-gray-100 shadow-sm">
                                        ...
                                        <div className="space-y-4">
                                            <div>
                                                ...
                                                <p className="font-medium text-neutral-800">{`Dr. ${appointment.doctor_first_name} ${appointment.doctor_last_name}`}</p>
                                            </div>
                                            ...
                                            <div className="bg-white rounded-lg p-4 border border-neutral-200 shadow-sm">
                                                <div className="flex items-start">
                                                    ...
                                                    <div className="flex-1">
                                                        ...
                                                        <button onClick={() => navigate("/patient-dashboard/*")} className="bg-error-50 hover:bg-error-100 text-error-600 px-4 py-2 rounded-lg transition-colors duration-200 flex items-center text-sm font-medium">
                                                            Cancel
