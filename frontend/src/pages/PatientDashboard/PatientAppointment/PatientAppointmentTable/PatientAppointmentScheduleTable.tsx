                    ...
                    .map((appointment, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <td className="p-4 text-gray-600 text-sm font-medium relative">
                                    {(() => {
                                        const {
                                            visible,
                                            hiddenItems,
                                        ...
                                        return (
                                            <ShowMoreTooltip
                                                ...
                                                tooltipClassName="absolute left-0 bottom-full mb-2 hidden group-hover:block bg-white border border-gray-200 rounded-md shadow-xl p-3 z-[9999] min-w-max max-w-xs"
                                            />
                                        );
                                    })()}
                                </td>
                                <td className="p-4 flex items-center gap-3 text-gray-600 text-sm">
