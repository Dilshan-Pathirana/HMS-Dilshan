    ...
    return (
        <div className="p-6 space-y-6 bg-neutral-50 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-neutral-900">Branch Analytics</h1>
                    <p className="text-neutral-500">{analytics.branch.name} - Sales Performance</p>
                </div>
                <div className="flex items-center gap-2">
                    ...
                    <select
                        ...
                        className="border border-neutral-300 rounded-lg px-4 py-2 bg-white text-neutral-700 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                    ...
                    <div className="mt-4">
                        ...
                        <p className="text-2xl font-bold text-neutral-900">{summary.total_transactions}</p>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                    ...
                    <div className="mt-4">
                        ...
                        <p className={`text-2xl font-bold ${(summary.total_cash_in - summary.total_cash_out) >= 0 ? 'text-green-600' : 'text-error-600'}`}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        {daily_sales.map((day) => {
                            ...
                            return (
                                <div key={day.date} className="flex items-center gap-3">
                                    ...
                                    <span className="text-xs font-medium text-neutral-700 w-24 text-right">
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                    <h3 className="text-lg font-semibold text-neutral-900 mb-4">Payment Method Distribution</h3>
                        ...
                        {[
                            ...
                            return (
                                <div key={method.label} className="bg-neutral-50 rounded-lg p-4">
                                    ...
                                    <p className="text-xl font-bold text-neutral-900">{percentage}%</p>
            ...
            {/* Top Cashiers */}
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                <h3 className="text-lg font-semibold text-neutral-900 mb-4">Top Performing Cashiers</h3>
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="border-b border-neutral-200">
                                    ...
                                    <th className="text-right py-3 px-4 text-sm font-semibold text-neutral-600">Transactions</th>
                                    <th className="text-right py-3 px-4 text-sm font-semibold text-neutral-600">Total Sales</th>
                                </tr>
                            </thead>
                            <tbody>
