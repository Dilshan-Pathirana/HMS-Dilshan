...
import SuperAdminTransferReasonModal from "./SuperAdminTransferReasonModal.tsx";
import Pagination from "../../../../Common/Pagination.tsx";

export default function SuperAdminTransferStockTable({
    products,
    searchTerm,
    setSearchTerm,
