...
import PharmacistUserDamageStockTable from "./damageStockList/PharmacistUserDamageStockTable.tsx";
...
import { getAllDamageStockDetails } from "../../../../../utils/api/pharmacy/PharmacyPOS/PharmacistUserPOS/PharmacistUserGetAllDamagedStock.ts";

export default function PharmacistUserDamageStockListPage() {
    ...
    return (
        <div className="p-6 pb-10">
            ...
            {!isLoading && (
                <PharmacistUserDamageStockTable
