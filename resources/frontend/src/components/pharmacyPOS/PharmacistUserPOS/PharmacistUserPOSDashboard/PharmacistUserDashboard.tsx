...
import { getAllDashboardDetails } from "../../../../utils/api/pharmacy/PharmacyPOS/PharmacistUserPOS/PharmacistUserGetAllDashboardDetails.ts";
import TotalSalesCard from "../../Common/TotalSalesCard.tsx";

const PharmacistUserDashboardPage = () => {
...
export default PharmacistUserDashboardPage;
