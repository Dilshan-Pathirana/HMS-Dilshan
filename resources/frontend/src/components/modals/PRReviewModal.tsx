...
export const PRReviewModal: React.FC<PRReviewModalProps> = ({ isOpen, onClose, purchaseRequest }) => {
    ...
    const fetchSuppliers = async () => {
        try {
            ...
            let response;
            try {
                response = await axios.get('/api/branch-admin/suppliers');
            } catch {
                // Fallback to super admin endpoint if branch admin endpoint fails
                response = await axios.get('/api/get-suppliers');
            }
    ...
    const performAdvancedSearch = useCallback(async (query: string) => {
        ...
        try {
            const response = await axios.get('/api/branch-admin/purchase-requests/search-items', {
                params: { search: query }
            });
    ...
    const handleSaveChanges = async () => {
        ...
        setLoading(true);
        try {
            const response = await axios.put(`/api/branch-admin/purchase-requests/${purchaseRequest.id}/update`, {
    ...
    const handleApprove = async () => {
        setLoading(true);
        try {
            const response = await axios.post(`/api/branch-admin/purchase-requests/${purchaseRequest.id}/approve`, {
    ...
    const handleReject = async () => {
        ...
        setLoading(true);
        try {
            const response = await axios.post(`/api/branch-admin/purchase-requests/${purchaseRequest.id}/reject`, {
    ...
    const handleRequestClarification = async () => {
        ...
        setLoading(true);
        try {
            const response = await axios.post(`/api/branch-admin/purchase-requests/${purchaseRequest.id}/clarify`, {
