...
import SupplierCreateFormForAdmin from "./SupplierCreateFormForAdmin.tsx";
import {
    SelectOption,
    Suppliers,
    SupplierStepProps,
...
const SupplierInformationForAdminUser: React.FC<SupplierStepProps> = ({
    data,
    setData,
    onNext,
    onBack,
...
export default SupplierInformationForAdminUser;
