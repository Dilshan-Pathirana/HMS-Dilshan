...
export const mapDetailsToRoleFields = (details: any, roleAs: UserRole) => {
    if (roleAs === UserRole.Cashier) {
        ...
        return {
            ...
            branch_ids: details.branch_ids || details.doctors_branches || [],
            doctors_date_of_birth: details.doctors_date_of_birth,
            doctors_gender: details.doctors_gender,
            doctors_nic_number: details.doctors_nic_number,
            doctors_contact_number_mobile:
                details.doctors_contact_number_mobile,
            doctors_contact_number_landline:
                details.doctors_contact_number_landline,
            doctors_home_address: details.doctors_home_address,
            doctors_emergency_contact_info:
                details.doctors_emergency_contact_info,
            doctors_years_of_experience: details.doctors_years_of_experience,
            doctors_joining_date: details.doctors_joining_date,
            doctors_employee_id: details.doctors_employee_id,
            doctors_contract_type: details.doctors_contract_type,
            doctors_contract_duration: details.doctors_contract_duration,
            doctors_compensation_package: details.doctors_compensation_package,
            doctors_registration_number: details.doctors_registration_number,
            doctors_qualifications: details.doctors_qualifications,
            doctors_areas_of_specialization:
                details.doctors_areas_of_specialization,
            doctors_license_validity_date:
                details.doctors_license_validity_date,
            doctors_previous_employment: details.doctors_previous_employment,
            doctors_probation_start_date: details.doctors_probation_start_date,
            doctors_probation_end_date: details.doctors_probation_end_date,
        };
    }
    return details;
};
