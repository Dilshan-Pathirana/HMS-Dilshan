...
const HRPolicies: React.FC = () => {
    ...
    const fetchPolicies = async () => {
        try {
            ...
            const response = await axios.get('/api/hrm/super-admin/policies', {
                headers: { Authorization: `Bearer ${token}` },
                params
            });
            if (response.data.status === 200) {
    ...
    const fetchStats = async () => {
        try {
            ...
            const response = await axios.get('/api/hrm/super-admin/policies/stats', {
                headers: { Authorization: `Bearer ${token}` },
                params
            });
            if (response.data.status === 200) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const url = isEditMode
                ? `/api/hrm/super-admin/policies/${selectedPolicy?.id}`
                : '/api/hrm/super-admin/policies';
    ...
    const handleCopyToBranch = async () => {
        ...
        try {
            ...
            const response = await axios.post('/api/hrm/super-admin/policies/copy-to-branch', {
    ...
    const handleDelete = async (id: string) => {
        ...
        try {
            const token = localStorage.getItem('token');
            await axios.delete(`/api/hrm/super-admin/policies/${id}`, {
                headers: { Authorization: `Bearer ${token}` }
            });
            fetchPolicies();
            fetchStats();
