    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Find a doctor and schedule your visit</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          ...
          {currentStep === 'search' && (
            <div>
              ...
              {doctors.length > 0 && (
                <div className="mt-6">
                  <h3 className="text-lg font-medium text-gray-800 mb-3">Available Doctors</h3>
          ...
          {currentStep === 'slots' && booking.selectedDoctor && (
            <div>
              ...
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-gray-800">{booking.selectedDoctor.name}</h2>
                  <p className="text-indigo-600">{booking.selectedDoctor.specialization}</p>
                </div>
              </div>

              <h3 className="text-lg font-medium text-gray-800 mb-3">Select Date & Time</h3>
              
              {availableDays.length === 0 ? (
                <p className="text-gray-500 py-8 text-center">No available slots in the next 14 days</p>
              ) : (
                    ...
                    <div key={day.date} className="border border-gray-200 rounded-lg p-4">
                      <div className="flex items-center justify-between mb-3">
                        <div>
                          ...
                          <span className="text-gray-500 ml-2">{new Date(day.date).toLocaleDateString()}</span>
                        </div>
              ...
              <div className="bg-indigo-50 rounded-lg p-4 mb-6">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="font-medium text-gray-800">{booking.selectedDoctor.name}</p>
                  </div>
                  <div>
                    <span className="text-sm text-gray-500">Specialization</span>
                    <p className="font-medium text-gray-800">{booking.selectedDoctor.specialization || 'General'}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-800">{booking.selectedSlot.time}</p>
                  </div>
                </div>
              </div>
            ...
            <div className="text-center py-8">
              ...
              <div className="bg-indigo-50 rounded-lg p-4 mb-6 text-left max-w-md mx-auto">
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    <span className="text-sm text-gray-500">Date</span>
                    <p className="font-medium text-gray-800">{createdBooking.appointment_date}</p>
                  </div>
                  <div>
                    <span className="text-sm text-gray-500">Time</span>
                    <p className="font-medium text-gray-800">{createdBooking.appointment_time}</p>
                  </div>
                </div>
              </div>
