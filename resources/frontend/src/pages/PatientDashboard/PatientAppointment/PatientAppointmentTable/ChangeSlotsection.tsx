    ...
    const handleShowAllBranches = async () => {
        ...
        try {
            const scheduleRes = await axios.get<{
                doctorSchedule: MoreBranchesProps[];
            ...
            const schedulesWithBranches: MoreBranchesProps[] =
                scheduleRes.data.doctorSchedule.map((schedule) => {
    ...
    const handleDateSelect = async (date: Date | null) => {
        ...
        try {
            ...
            const response = await axios.post(
                "/api/check-doctor-availability-user",
                {
                    doctor_id: appointment.doctor_id,
    ...
    const handleConfirmChange = async () => {
        ...
        try {
            ...
            const response = await axios.put(
                `/api/change-appointment-date/${appointment.user_id}`,
                {
                    doctor_id: appointment.doctor_id,
