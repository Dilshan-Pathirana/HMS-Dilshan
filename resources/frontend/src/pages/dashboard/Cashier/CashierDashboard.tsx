...
export const CashierDashboard: React.FC = () => {
    ...
    const fetchDashboardData = async () => {
        try {
            const response = await axios.get('/api/cashier/dashboard-stats');
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-gray-600 mt-1">Manage payments and billing efficiently.</p>
                        </div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center justify-between p-3 bg-emerald-50 rounded-lg border border-emerald-200">
                                <div>
                                    <p className="font-medium text-gray-800">Payment #12345</p>
                                    <p className="text-xs text-gray-500">John Doe - Consultation</p>
                                </div>
                                <span className="text-lg font-bold text-emerald-600">$150</span>
                            </div>
                            <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg border border-blue-200">
                                <div>
                                    <p className="font-medium text-gray-800">Payment #12344</p>
                                    <p className="text-xs text-gray-500">Jane Smith - Lab Tests</p>
                                </div>
                                <span className="text-lg font-bold text-blue-600">$85</span>
                            </div>
                            <div className="flex items-center justify-between p-3 bg-purple-50 rounded-lg border border-purple-200">
                                <div>
                                    <p className="font-medium text-gray-800">Payment #12343</p>
                                    <p className="text-xs text-gray-500">Robert Wilson - Pharmacy</p>
                                </div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        ...
                        <div className="space-y-3">
                            <button className="w-full flex items-center gap-3 px-4 py-3 bg-gradient-to-r from-emerald-50 to-blue-50 rounded-lg hover:from-emerald-100 hover:to-blue-100 transition-all text-left">
                                ...
                                <div>
                                    <p className="font-medium text-gray-800">Create New Bill</p>
                                    <p className="text-xs text-gray-500">Generate patient invoice</p>
                                </div>
                            </button>
                            <button className="w-full flex items-center gap-3 px-4 py-3 bg-gradient-to-r from-emerald-50 to-blue-50 rounded-lg hover:from-emerald-100 hover:to-blue-100 transition-all text-left">
                                <CreditCard className="w-5 h-5 text-blue-600" />
                                <div>
                                    <p className="font-medium text-gray-800">Process Payment</p>
                                    <p className="text-xs text-gray-500">Accept payment from patient</p>
                                </div>
                            </button>
                            <button className="w-full flex items-center gap-3 px-4 py-3 bg-gradient-to-r from-emerald-50 to-blue-50 rounded-lg hover:from-emerald-100 hover:to-blue-100 transition-all text-left">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500">Financial reports & summaries</p>
                                </div>
                            </button>
                        </div>
                        ...
                        <div className="mt-6 pt-6 border-t border-gray-200">
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                ...
                                <div className="p-3 bg-gray-50 rounded-lg text-center">
                                    <DollarSign className="w-6 h-6 mx-auto text-gray-600 mb-1" />
