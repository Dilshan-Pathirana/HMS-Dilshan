...
export const PharmacistDashboard: React.FC = () => {
    ...
    const fetchDashboardData = async () => {
        try {
            const response = await axios.get('/api/pharmacist/dashboard-stats');
    ...
    const StatCard = ({ 
        ...
        <div className={`bg-white rounded-xl shadow-sm border ${alert ? 'border-red-300' : 'border-gray-200'} p-6 hover:shadow-md transition-shadow relative`}>
            {alert && (
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-gray-600 mt-1">Manage pharmacy inventory and prescriptions efficiently.</p>
                        </div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center justify-between p-3 bg-red-50 rounded-lg border border-red-200">
                                <div>
                                    <p className="font-medium text-gray-800">Paracetamol 500mg</p>
                                    <p className="text-xs text-gray-500">Only 15 units left</p>
                                </div>
                            ...
                            <div className="flex items-center justify-between p-3 bg-red-50 rounded-lg border border-red-200">
                                <div>
                                    <p className="font-medium text-gray-800">Amoxicillin 250mg</p>
                                    <p className="text-xs text-gray-500">Only 8 units left</p>
                                </div>
                                <button className="px-3 py-1 bg-red-600 text-white text-xs rounded-lg hover:bg-red-700">
                                    Reorder
                                </button>
                            ...
                            <div className="flex items-center justify-between p-3 bg-yellow-50 rounded-lg border border-yellow-200">
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500">25 units left</p>
                                </div>
                        ...
                        <div className="space-y-3">
                            <button className="w-full flex items-center gap-3 px-4 py-3 bg-gradient-to-r from-emerald-50 to-blue-50 rounded-lg hover:from-emerald-100 hover:to-blue-100 transition-all text-left">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500">Add item to inventory</p>
                                </div>
                            </button>
                            <button className="w-full flex items-center gap-3 px-4 py-3 bg-gradient-to-r from-emerald-50 to-blue-50 rounded-lg hover:from-emerald-100 hover:to-blue-100 transition-all text-left">
                                <FileText className="w-5 h-5 text-blue-600" />
                                <div>
                                    <p className="font-medium text-gray-800">Process Prescription</p>
                                    <p className="text-xs text-gray-500">Handle new prescription</p>
                                </div>
                            </button>
                            <button className="w-full flex items-center gap-3 px-4 py-3 bg-gradient-to-r from-emerald-50 to-blue-50 rounded-lg hover:from-emerald-100 hover:to-blue-100 transition-all text-left">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500">Record a sale transaction</p>
                                </div>
                            </button>
                        </div>
                    </div>
