            ...
            <div className="p-6">
                ...
                <div className="flex justify-between items-start mb-6">
                    <div>
                        ...
                        <p className="text-gray-600">Report adverse drug reactions and medication errors</p>
                    </div>
                    <button
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                    <div className="bg-white rounded-lg shadow p-4 border-l-4 border-red-500">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm text-gray-600">Total ADR Reports</p>
                                <p className="text-2xl font-bold text-gray-900">{adrReports.length}</p>
                            </div>
                    ...
                    <div className="bg-white rounded-lg shadow p-4 border-l-4 border-orange-500">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm text-gray-600">Medication Errors</p>
                                <p className="text-2xl font-bold text-gray-900">{medicationErrors.length}</p>
                            </div>
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <div className="grid grid-cols-2 gap-4 text-sm">
                                                    <div>
                                                        ...
                                                        <span className="ml-2 text-gray-900">{report.patient_name} ({report.patient_id})</span>
                                                    </div>
                                                    <div>
                                                        <span className="text-gray-500">Drug:</span>
                                                        <span className="ml-2 text-gray-900">{report.drug_name}</span>
                                                    </div>
                                                    <div>
                                                        <span className="text-gray-500">Reaction:</span>
                                                        <span className="ml-2 text-gray-900">{report.reaction_type}</span>
                                                    </div>
                                                    <div>
                                                        <span className="text-gray-500">Onset Date:</span>
                                                        <span className="ml-2 text-gray-900">{report.onset_date}</span>
                                                    </div>
                                                </div>
                                                <p className="text-sm text-gray-600 mt-2">{report.reaction_description}</p>
                                            </div>
                                ...
                                {medicationErrors.map((error) => (
                                    <div key={error.id} className="border rounded-lg p-4 hover:bg-gray-50">
                                        <div className="flex items-start justify-between">
                                            <div className="flex-1">
                                                <div className="flex items-center gap-3 mb-2">
                                                    <span className="font-semibold text-gray-900">{error.error_number}</span>
                                                ...
                                                <div className="grid grid-cols-2 gap-4 text-sm">
                                                    <div>
                                                        <span className="text-gray-500">Drug Involved:</span>
                                                        <span className="ml-2 text-gray-900">{error.drug_involved}</span>
                                                    </div>
                                                    <div>
                                                        <span className="text-gray-500">Detected By:</span>
                                                        <span className="ml-2 text-gray-900">{error.detected_by}</span>
                                                    </div>
                                                </div>
                                ...
                                <form className="space-y-6">
                                    ...
                                    <div className="border-b pb-6">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div>
                                                <label className="block text-sm font-medium text-gray-700 mb-1">Description of Reaction*</label>
                                                <textarea
