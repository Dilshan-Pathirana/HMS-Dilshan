...
export const PurchaseRequestList: React.FC = () => {
    ...
    const fetchStats = async () => {
        try {
            const response = await axios.get('/api/purchase-requests/stats');
            if (response.data.success) {
    ...
    const handleViewDetails = async (prId: string) => {
        try {
            const response = await axios.get(`/api/purchase-requests/${prId}`);
            if (response.data.success) {
    ...
    const handleDelete = async (prId: string, prNumber: string) => {
        ...
        try {
            const response = await axios.delete(`/api/purchase-requests/${prId}`);
            if (response.data.success) {
    ...
    const handleSubmit = async (prId: string, prNumber: string) => {
        ...
        try {
            const response = await axios.post(`/api/purchase-requests/${prId}/submit`);
            if (response.data.success) {
