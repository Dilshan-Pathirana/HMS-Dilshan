...
import { 
    Download, Eye, Search, ChevronDown, ChevronRight,
    DollarSign, Wrench, Shield, Lock,
    PieChart, Printer, FileSpreadsheet,
    Building2, Receipt, CreditCard,
    Pill, HeartPulse, FileCheck, FileWarning,
    Globe, Layers, Users, FileText, BarChart3
} from 'lucide-react';
...
export const SuperAdminReportsContent: React.FC = () => {
    ...
    const handleGenerateReport = (_reportId: string, reportName: string) => {
    ...
    return (
        <div className="p-4 space-y-6">
            {/* Header */}
            <div className="bg-gradient-to-r from-teal-50 via-cyan-50 to-blue-50 rounded-2xl p-6 border border-teal-100 shadow-sm">
                ...
                {filteredCategories.map((category) => (
                    <div key={category.id} className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <button
                            ...
                            className="w-full px-6 py-4 flex items-center justify-between hover:bg-gradient-to-r hover:from-teal-50 hover:to-cyan-50 transition-colors"
                        >
                                            ...
                                            <div key={report.id} className="bg-white rounded-lg p-4 border border-gray-200 hover:border-teal-300 hover:shadow-md transition-all">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <button
                                                        ...
                                                        className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-gradient-to-r from-teal-500 to-blue-600 text-white rounded-lg hover:from-teal-600 hover:to-blue-700 transition-colors text-sm"
                                                    >
