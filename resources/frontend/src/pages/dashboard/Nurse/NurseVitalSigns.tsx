...
const NurseVitalSigns: React.FC = () => {
  ...
  const getVitalStatus = (type: string, value: number): string => {
    switch (type) {
      case 'temp':
        if (value < 97 || value > 99.5) return 'text-red-600 bg-red-50';
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-2xl font-bold text-gray-900">{stats.totalToday}</span>
          </div>
          <h3 className="text-gray-600 text-sm font-medium">Total Recorded Today</h3>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-2xl font-bold text-gray-900">{stats.abnormal}</span>
          </div>
          <h3 className="text-gray-600 text-sm font-medium">Abnormal Readings</h3>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-2xl font-bold text-gray-900">{vitalSigns.length}</span>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <h3 className="text-gray-600 text-sm font-medium">Available Patients</h3>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div className="flex flex-col md:flex-row gap-4 justify-between items-center">
          ...
          <button
            ...
            className="bg-gradient-to-r from-blue-600 to-cyan-600 text-white px-6 py-2 rounded-lg hover:from-blue-700 hover:to-cyan-700 transition-all flex items-center gap-2 whitespace-nowrap"
          >
          ...
          <table className="w-full">
            <thead className="bg-gradient-to-r from-blue-50 to-cyan-50">
              <tr>
                ...
                <th className="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">BP</th>
                <th className="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">
                  <div className="flex items-center gap-2">
                ...
                filteredVitals.map((vital) => (
                  <tr key={vital.id} className="hover:bg-gray-50 transition-colors">
                    <td className="px-6 py-4">
                      <div>
                        <div className="font-medium text-gray-900">{vital.patient?.name || 'Unknown'}</div>
                        <div className="text-sm text-gray-500">{vital.patient?.registration_number || ''}</div>
                      </div>
                    </td>
                    <td className="px-6 py-4 text-sm text-gray-600">{formatDateTime(vital.recorded_at)}</td>
                    <td className="px-6 py-4">
                      {vital.temperature ? (
                    ...
                    <td className="px-6 py-4">
                      <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                        vital.is_abnormal ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800'
                      }`}>
          ...
          <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Consciousness (AVPU)</label>
                  <select
