...
export const NurseDashboardMain: React.FC = () => {
    ...
    const getShiftStatusBadge = (shift: NurseShift | null) => {
        ...
        return (
            <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${statusColors[shift.status] || 'bg-gray-100'}`}>
            ...
            <div>
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-6">
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                        ...
                        <button className="relative p-2 rounded-lg bg-white shadow hover:bg-gray-50">
                    ...
                    <div className="bg-white rounded-lg shadow p-4 border-l-4 border-teal-500">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-gray-900">{stats?.assignedPatients || 0}</p>
                                <p className="text-xs text-gray-500 mt-1">Under your care today</p>
                            </div>
                    ...
                    <div className="bg-white rounded-lg shadow p-4 border-l-4 border-green-500">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-gray-900">{stats?.vitalSignsRecorded || 0}</p>
                    ...
                    <div className="bg-white rounded-lg shadow p-4 border-l-4 border-yellow-500">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-gray-900">{stats?.pendingHandovers || 0}</p>
                                <p className="text-xs text-gray-500 mt-1">To acknowledge</p>
                            </div>
                        ...
                        <div className="bg-white rounded-lg shadow p-4 mb-6">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <button 
                                    ...
                                    className="p-4 border border-gray-200 rounded-lg hover:bg-blue-50 hover:border-blue-300 transition-all group"
                                >
                                    <Heart className="w-6 h-6 text-blue-600 mb-2 mx-auto" />
                                    <p className="text-sm text-gray-700 group-hover:text-blue-700 font-medium">Vital Signs</p>
                                </button>
                                <button 
                                    onClick={() => navigate('/nurse-dashboard/patients')}
                                    className="p-4 border border-gray-200 rounded-lg hover:bg-purple-50 hover:border-purple-300 transition-all group"
                                >
                                    <Users className="w-6 h-6 text-purple-600 mb-2 mx-auto" />
                                    <p className="text-sm text-gray-700 group-hover:text-purple-700 font-medium">Patients</p>
                                </button>
                                <button 
                                    onClick={() => navigate('/nurse-dashboard/handover')}
                                    className="p-4 border border-gray-200 rounded-lg hover:bg-green-50 hover:border-green-300 transition-all group"
                                >
                                    <FileText className="w-6 h-6 text-green-600 mb-2 mx-auto" />
                                    <p className="text-sm text-gray-700 group-hover:text-green-700 font-medium">Handover</p>
                                </button>
                                <button 
                                    onClick={() => navigate('/nurse-dashboard/tasks')}
                                    className="p-4 border border-gray-200 rounded-lg hover:bg-orange-50 hover:border-orange-300 transition-all group"
                                >
                                    <ClipboardList className="w-6 h-6 text-orange-600 mb-2 mx-auto" />
                                    <p className="text-sm text-gray-700 group-hover:text-orange-700 font-medium">Tasks</p>
                                </button>
                            </div>
                        </div>
                            ...
                            {stats?.upcomingShifts && stats.upcomingShifts.length > 0 ? (
                                <div className="space-y-3">
                                    {stats.upcomingShifts.slice(0, 3).map((shift) => (
                                        <div key={shift.id} className="p-3 bg-gray-50 border border-gray-200 rounded-lg">
                        ...
                        <div className="bg-white rounded-lg shadow mb-6">
                            ...
                            {stats?.recentVitalSigns && stats.recentVitalSigns.length > 0 ? (
                                        ...
                                        <div key={vital.id} className="p-4 hover:bg-gray-50">
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <p className="font-medium text-gray-900">{vital.patient?.name || 'Unknown Patient'}</p>
                                                ...
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div className="text-right">
                                                        ...
                                                        <p className="text-sm font-medium text-gray-700">{formatRecordedTime(vital.recorded_at)}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div className="p-8 text-center">
                                    ...
                                    <p className="text-gray-500">No vital signs recorded today</p>
                                    <button 
                                        onClick={() => navigate('/nurse-dashboard/vital-signs')}
