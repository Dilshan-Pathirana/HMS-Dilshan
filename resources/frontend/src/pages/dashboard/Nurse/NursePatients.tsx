            ...
            <div>
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-6">
                    <div>
                        ...
                        <p className="text-gray-600">Manage and monitor patients under your care</p>
                    </div>
                    <button
                ...
                {loading ? (
                    ...
                    <div className="bg-white rounded-lg shadow p-12 text-center">
                        ...
                        <p className="text-gray-400 text-sm mt-2">Patients assigned to you will appear here</p>
                    </div>
                ) : (
                    /* Patients Grid */
                        ...
                        <div key={patient.id} className="bg-white rounded-lg shadow hover:shadow-lg transition-shadow">
                            ...
                            <div className="p-4 space-y-3">
                                ...
                                <div className="pt-3 border-t">
                                    <p className="text-xs text-gray-500 mb-2">Last Vitals ({patient.last_vitals.time})</p>
                                    <div className="grid grid-cols-2 gap-2 text-sm">
                                        <div className="flex items-center gap-1">
                                            <Activity className="w-3 h-3 text-gray-400" />
                                            <span className="text-gray-600">BP: {patient.last_vitals.bp}</span>
                                        </div>
                                        <div className="flex items-center gap-1">
                                            <Heart className="w-3 h-3 text-gray-400" />
                                            <span className="text-gray-600">HR: {patient.last_vitals.pulse}</span>
                                        </div>
                                        <div className="flex items-center gap-1">
                                            <Activity className="w-3 h-3 text-gray-400" />
                                            <span className="text-gray-600">SpO2: {patient.last_vitals.spo2}</span>
                                        </div>
                                        <div className="flex items-center gap-1">
                                            <Activity className="w-3 h-3 text-gray-400" />
                                            <span className="text-gray-600">Temp: {patient.last_vitals.temperature}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="p-4 border-t flex items-center gap-2">
                                ...
                                <button className="p-2 border border-gray-300 rounded-lg hover:bg-gray-50" title="Patient Notes">
                        ...
                        <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl mx-4 max-h-[90vh] overflow-y-auto">
                            ...
                            <div className="p-6">
                                <div className="grid grid-cols-2 gap-6 mb-6">
                                    <div>
                                        <label className="text-xs text-gray-500 uppercase">Patient Name</label>
                                        <p className="text-gray-900 font-medium">{selectedPatient.name}</p>
                                    </div>
                                    <div>
                                        <label className="text-xs text-gray-500 uppercase">Bed Number</label>
                                        <p className="text-gray-900 font-medium">{selectedPatient.bed_number}</p>
                                    </div>
                                    <div>
                                        <label className="text-xs text-gray-500 uppercase">Age / Gender</label>
                                    ...
                                    <div>
                                        <label className="text-xs text-gray-500 uppercase">Attending Doctor</label>
                                        <p className="text-gray-900">{selectedPatient.doctor}</p>
                                    </div>
                                    <div>
                                        <label className="text-xs text-gray-500 uppercase">Admission Date</label>
                                        <p className="text-gray-900">{new Date(selectedPatient.admission_date).toLocaleDateString()}</p>
                                    </div>
                                </div>
                                ...
                                <div className="border-t pt-4">
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                        <div className="p-3 bg-blue-50 rounded-lg">
                                            ...
                                            <p className="text-lg font-semibold text-gray-900">{selectedPatient.last_vitals.bp}</p>
                                        </div>
                                        <div className="p-3 bg-red-50 rounded-lg">
                                            <p className="text-xs text-gray-600 mb-1">Heart Rate</p>
                                            <p className="text-lg font-semibold text-gray-900">{selectedPatient.last_vitals.pulse}</p>
                                        </div>
                                        <div className="p-3 bg-green-50 rounded-lg">
                                            <p className="text-xs text-gray-600 mb-1">SpO2</p>
                                            <p className="text-lg font-semibold text-gray-900">{selectedPatient.last_vitals.spo2}</p>
                                        </div>
                                        <div className="p-3 bg-yellow-50 rounded-lg">
                                            <p className="text-xs text-gray-600 mb-1">Temperature</p>
                                            <p className="text-lg font-semibold text-gray-900">{selectedPatient.last_vitals.temperature}</p>
                                        </div>
                                    </div>
                                    <p className="text-xs text-gray-500 mt-2">Recorded {selectedPatient.last_vitals.time}</p>
                                </div>
                            </div>
