...
export const BranchAdminAppointments: React.FC = () => {
    ...
    const fetchAppointments = async () => {
        setLoading(true);
        try {
            const response = await axios.get('/api/get-all-patient-appointment');
    ...
    const fetchDoctorSchedules = async (doctorId: string, date: string) => {
        try {
            const response = await axios.get('/api/get-filter-doctor-schedules', {
                params: {
                    doctor_id: doctorId,
                    date: date
                }
    ...
    const handleCreateAppointment = async () => {
        try {
            const response = await axios.post('/api/admin-create-patient-appointment', newAppointment);
