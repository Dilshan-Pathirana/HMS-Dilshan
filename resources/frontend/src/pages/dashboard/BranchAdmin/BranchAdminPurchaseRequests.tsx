...
export const BranchAdminPurchaseRequests: React.FC = () => {
    ...
    const fetchPendingCount = async () => {
        try {
            const response = await axios.get('/api/branch-admin/purchase-requests/pending-count');
    ...
    const fetchPurchaseRequests = async () => {
        ...
        try {
            ...
            const response = await axios.get('/api/branch-admin/purchase-requests/pending', { params });
    ...
    const handleViewPR = async (pr: PurchaseRequest) => {
        try {
            const response = await axios.get(`/api/branch-admin/purchase-requests/${pr.id}`);
            if (response.data.success) {
