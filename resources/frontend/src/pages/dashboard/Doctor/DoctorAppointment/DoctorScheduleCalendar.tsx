...
const DoctorScheduleCalendar: React.FC = () => {
    ...
    const fetchSchedules = async () => {
        ...
        try {
            ...
            const response = await axios.get(
                `/api/get-all-doctor-schedule/${currentUserId}`,
            );
    ...
    const fetchCancellations = async () => {
        ...
        try {
            const response = await axios.get(
                `/api/get-doctor-schedule-cancel/${currentUserId}`,
            );
    ...
    const confirmCancelSchedule = async (reason: string) => {
        ...
        try {
            ...
            const response = await axios.post(
                "/api/request-cancel-doctor-appointment",
                {
                                ...
                                >
                                    <div
                                        className={`
                                            ...
                                            ${calendarDate.isToday ? "text-blue-600" : ""}
                                        `}
                                    >
                                                ...
                                                >
                                                    <div className="flex items-start justify-between mb-2">
                                                        ...
                                                        {canCancel ? (
                                                            ...
                                                            <div className="flex items-center">
                                                                <span
                                                                    className="text-xs text-gray-500 px-2 py-1 rounded border bg-gray-100 flex items-center cursor-not-allowed"
                                                    ...
                                                    <div className="space-y-1 text-sm">
                                                        ...
                                                        {existingCancellation && (
                                                            <div className="text-gray-600 text-xs mt-2 p-2 bg-gray-100 rounded">
                                                                <strong>
                                                                    Cancellation
                                                                    Status:
                                                                </strong>{" "}
